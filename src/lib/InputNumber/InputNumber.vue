<template>
  ...
  <div class="e-input-number" :class="inputNumberClasses">
    <span ref="leftBtnRef" :class="{'is-disabled':decreaseDisabled}" class="e-inputNumBtn e-inputNum-decrease"
          @click="decreaseNum">
      <svg>
        <use xlink:href="#icon-decrease"></use>
      </svg>
    </span>
    <span ref="rightBtnRef" :class="{'is-disabled':increaseDisabled}" class="e-inputNumBtn e-inputNum-increase"
          @click="increaseNum">
      <svg>
        <use xlink:href="#icon-increase"></use>
      </svg>
    </span>
    <div class="e-input" :class="{'is-focused':inputFocus}">
      <input :disabled="disabled" class="e-input-inner" type="text" :value="modelValue" @blur="toggleInputFocus(false)"
...
const inputNumberClasses = computed(() => {
  return {
    ...
    [`e-input-number-${props.size}`]: props.size
  };
});
